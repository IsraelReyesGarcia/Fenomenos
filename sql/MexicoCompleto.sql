...
CREATE TABLE `estados` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_id_pais` (`id_pais`) USING BTREE,
  CONSTRAINT `fk_id_pais` FOREIGN KEY (`id_pais`) REFERENCES `paises` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `municipios` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_id_estado` (`id_estado`) USING BTREE,
  CONSTRAINT `fk_id_estado` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
